...
class BannerAd(context: Context, attrs: AttributeSet) : LinearLayout(context, attrs) {
    ...
    // exists.
    suspend fun <T> loadAd(
        baseActivity: T,
        clientMessage: String,
        allowSdkActivityLaunch: () -> Boolean,
        shouldLoadWebView: Boolean,
        mediationType: String) where T : Activity, T : LifecycleOwner {
    ...
    private suspend fun <T> getBannerAdFromRuntimeEnabledSdkIfExists(
        baseActivity: T,
        message: String,
        allowSdkActivityLaunch: () -> Boolean,
        shouldLoadWebView: Boolean,
        mediationType: String
    ): SandboxedUiAdapter? where T : Activity, T : LifecycleOwner {
